...
export default function SingleProductPage() {
    ...
    return (
        <>
            ...
            <ProductConsumer>
                {value => {
                    const {storeProducts, loading, addToFavourites, favourites} = value;
                    ...
                    if (loading) {
                        ...
                        const {username, description, price, title, size, main_image, image2, image3} = singleProduct;
                                    ...
                                    <div className="container-fluid">
                                        ...
                                        <div className="row">
                                            ...
                                            <div
                                                ...
                                                <h5 className="text-capitalize text-muted mb-4">Added by {username}</h5>
                                            ...
                                            <div className="col-10 mx-auto col-sm-6 col-md-4 col-lg-2 my-3 offset-1">
                                                <div className="row right-container">
                                                    ...
                                                    <h6 className="text-capitalize my-3">
                                                        ...
                                                        <button
                                                            className={favourites.find(item => item.id === singleProduct.id) ? "mx-1 fav-btn" : "mx-1 fav-btn-muted"}
                                                            onClick={() => addToFavourites(singleProduct)}>
                                                            <FaHeart/>
                                                        </button>
                                                        {favourites.find(item => item.id === singleProduct.id) ? "Added" : "add to favourites"}
                                                    </h6>
                                                </div>

...
INSERT INTO products(id, title, price, user_id, description, size, featured, free_shipping) VALUES (1, 'Sukienka plus size 42-50', 85, 2, 'Przepiękna sukienka zakupiona w tym miesiącu w sklepie butik na plus. Niestety okazała się zbyt obszerna, a paragon gdzieś zaginął. Zakupiona za ok. 160 zł. Z aktualnej kolekcji, z tego względu też cena sukienki nie podlega negocjacji. Piękna, letnia, w delikatny wzór kwiatów. Można nosić ją z paskiem lub bez.Biust 118-130 Biodra 128-130 Długość 130 Biceps 38', 'XL', true, true);
INSERT INTO products(id, title, price, user_id, description, size, featured, free_shipping) VALUES (2, 'Sukienka Tatuum S 36 piękne kolory', 36, 2, 'Sprzedam piekna sukienke, jest przewiewna z naturalnego materialu o pieknych kolorach. Dlugosc za kolana przy 170 cm wzrostu, fajny dekolt. Stan oceniam na b. dobry.', 'S', true, true);
INSERT INTO products(id, title, price, user_id, description, size, featured, free_shipping) VALUES (3, 'Sweter męski 100% wełny merynosa xxl', 30, 2, 'Mam do sprzedania sweter z 100% welny merynosa. Rozmiar xxl. Wysylka: 10 zl', 'XXL', true, false);
INSERT INTO products(id, title, price, user_id, description, size, featured, free_shipping) VALUES (4, 'Kurtka termiczna damska stormberg L softshell przeciwdeszczowa 4f', 65, 2, 'Kurtka damska rozmiar L.Firmy Stromberg. Oddychajaca ,wodoszczelna,Wiatroszczelna, Caloroczna . Możliwa wysyłka 15 zł lub odbior osobisty"', 'L', false , false);
INSERT INTO products(id, title, price, user_id, description, size, featured, free_shipping) VALUES (5, 'Ciemnorozowa bluzka new look 44 luzna z przodu zakladana', 20, 2, 'Bluzke ciezko zmierzyc ,bo na plasko kiepsko sie uklada. Jest na tyle elastyczna ze bedzie rowniez dobra na xxxl.', 'XXL', false , false);
INSERT INTO products(id, title, price, user_id, description, size, featured, free_shipping) VALUES (6, 'Jeansowa katana cubus dziewczeca 158/164 kozuszek', 40, 2, 'Dlugosc 53,pachy45,biust45,pas44 od pachy33 ,dl.rekawa 60/43 ,sz.rekawa 10 . 100% bawelna material jeansowy, kozuszek100% poliester. Rozmiar dzieciecy jednak nosila osoba w rozmiarze xxs/xs byla idealna. Prosze sugerowac sie wymiarami.', 'XS', false , false);
